 ...
 * modified by alberto
 */
public class ServiceGWTWizardPage extends AbstractGwtWizardPage {
  private final IPackageFragment m_selectedPackage;
  private ServiceGWTComposite m_serviceComposite;
  ...
  //
  ////////////////////////////////////////////////////////////////////////////
  public ServiceGWTWizardPage(IPackageFragment selectedPackage) {
  ...
  protected void createPageControls(Composite parent) {
    // create GWT parameters composite
    {
      ...
      m_serviceComposite =
          new ServiceGWTComposite(parent, SWT.NONE, messagesContainer, m_selectedPackage);
  ...
  public void createService() throws Exception {
    ...
    //
    CreateServiceGWTOperation operation = new CreateServiceGWTOperation();
    operation.create(packageFragment, serviceName, classDTO, m_serviceComposite.getLogin());
  }
}
