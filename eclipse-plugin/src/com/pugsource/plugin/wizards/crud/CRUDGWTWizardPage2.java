 ...
 * @author alberto
 */
public class CRUDGWTWizardPage2 extends AbstractGwtWizardPage {
  private IPackageFragment m_selectedPackage;
  private CRUDGWTComposite2 m_serviceComposite;
  ...
  //
  ////////////////////////////////////////////////////////////////////////////
  public CRUDGWTWizardPage2(IPackageFragment selectedPackage, CRUDGWTWizardPage1 crudGWTWizardPage1) {
  ...
  protected void createPageControls(Composite parent) {
    // create GWT parameters composite
    {
      ...
      m_serviceComposite =
          new CRUDGWTComposite2(parent, SWT.NONE, messagesContainer, m_selectedPackage);
      this.crudGWTWizardPage1.m_serviceComposite1.pageComposite2 = m_serviceComposite;
