 ...
 * @author alberto
 */
public class CRUDGWTWizard extends Wizard implements INewWizard {
  private IPackageFragment m_selectedPackage;
  private CRUDGWTWizardPage1 m_servicePage1;
  private CRUDGWTWizardPage2 m_servicePage2;
  private CRUDGWTWizardPage3 m_servicePage3;
  ...
  public void addPages() {
    m_servicePage1 = new CRUDGWTWizardPage1(m_selectedPackage);
    m_servicePage2 = new CRUDGWTWizardPage2(m_selectedPackage, m_servicePage1);
    m_servicePage3 = new CRUDGWTWizardPage3(m_selectedPackage, m_servicePage1);
  ...
  public CRUDGWTWizardPage1 page1() {
	  return m_servicePage1;
  }
  
  public CRUDGWTWizardPage2 page2() {
