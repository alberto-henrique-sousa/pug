 ...
 */
public class CreateViewGWTOperation extends AbstractCreateGWTOperation {
  ...
  //
  ////////////////////////////////////////////////////////////////////////////
  public CreateViewGWTOperation(IPackageFragmentRoot root) {
    this.root = root;
  }
  ...
  private IFile createPlace(ViewConfiguration configuration) throws Exception {
    ...
    // ensure module inherits
    {
      ...
      ConfigureMvpGWTOperation.ensureInheritsPlace(module);
    }
    // prepare variables
    Map<String, String> variables = configuration.getVariables();
    variables.put("className", className);
  ...
  private IFile createActivity(ViewConfiguration configuration) throws Exception {
    ...
    {
      ModuleDescription module = Utils.getSingleModule(packageFragment);
      ConfigureMvpGWTOperation.ensureInheritsActivity(module);
    }
    // prepare variables
    Map<String, String> variables = configuration.getVariables();
    variables.put("className", className);
    ...
    if (useClientFactory) {
      ...
      ViewGWTComposite.setClientFactoryName(
