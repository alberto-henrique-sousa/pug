 ...
 */
public class XHTMLWizardPage3 extends AbstractWizardPage {
  ...
  //
  ////////////////////////////////////////////////////////////////////////////
  public XHTMLWizardPage3(IPackageFragment selectedPackage, XHTMLWizardPage1 crudJSFWizardPage1) {
  ...
  protected void createPageControls(Composite parent) {
    {
      ...
      this.crudJSFWizardPage1.m_serviceComposite1.pageComposite3 = m_serviceComposite;
