...
import br.com.pug.plugin.jsf.wizards.guide.MigrationGuideWizard;

/**
 * @author Alberto (alberto.henrique.sousa@gmail.com)
 */
public class NewMigrationGuideAction extends AbstractOpenWizardDelegate {
  @Override
  protected IWizard createWizard() {
    return new MigrationGuideWizard();
  }
}
